...
export default class About extends Component {
	render() {
		return <div className="about">
			...
			<p className="about__content">In 2003 when Krystle was just 15 years old, her Dad passed away suddenly from a stage 4 cancerous brain tumor. Krystle's passion for photography quickly turned from a passion to a business as she didnt want any kids to have to go through what she went through -- not having any quality photos with their parents because they could not afford the thousand dollar professional portraits. </p>
			<p className="about__content">Because of this, KLiK was started to make quality photography affordable! </p>
			<p className="about__content">Due to Krystle's Dad passing from cancer and her having surgery in October 2015 to have cancer removed, Krystle knows how much things like this affect families. She likes to give back &amp; donates to many benefits throughout the year to families in the community. </p>
